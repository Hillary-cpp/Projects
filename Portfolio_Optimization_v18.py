...
def display_efficient_frontier_with_random(lst_weights_for_optimiation):
...
#     sdp_min, rp_min = calculate_portfolio_performance(min_vol['x'], mean_returns, cov_matrix)
...
# =============================================================================
   ...
   # plt.plot([p['fun'] for p in lst_weights_for_optimiation], target, linestyle='-.', color='black', label='efficient frontier')
